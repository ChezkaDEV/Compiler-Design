...
object Ex05 {
  ...
  def main (args : Array[String]) {
    ...
    testEval (p01, "if 1 + 2 * 3 then 1 + 2 * 3 else 1 + 2 * 3")
    testEval (p01, "if 1-2-3 then 1-2-3")
    testEval (p01, "if 1 + -2 ")
    testEval (p01, "if x++ then 1 + -2 else 1")
    testEval (p01, "if 1 + 1.2")
    testEval (p01, "if 1 + ")
    testEval (p01, "if x = 1 then let z = (17) in z + 2 * 3 fi")
    testEval (p01, "if d = 2 then let z = 17) in z + 2 * 3 else f = 2 fi")
    testEval (p01, "if x = 0 then let in = (17) in z + 2 * 3 else f = 2 fi")
    testEval (p01, "if 1 then let x = 5 in let y = 7 + x in y + y fi + x fi")
